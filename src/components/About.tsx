...
const techs = ["Node.js", "React", "TypeScript", "MySQL", "REST APIs", "Docker", "Git & GitHub"];
      ...
      <SectionReveal>
        ...
        <div className="max-w-3xl">
          ...
          <div className="flex flex-wrap gap-3 mb-6">
            {techs.map((t) => (
              <span key={t} className="px-4 py-2 rounded-md bg-secondary text-sm text-foreground border border-border">
                {t}
              </span>
            ))}
          </div>
